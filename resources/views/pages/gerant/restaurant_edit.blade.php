...
<div class="form-group">
    ...
    <input type="number" class="form-control @error('number_of_tables') is-invalid @enderror" id="number_of_tables" name="number_of_tables" value="{{ old('number_of_tables', $restaurant->number_of_tables) }}" min="1" required>
...
<div class="form-group">
    ...
    <input type="number" class="form-control @error('seats_per_table') is-invalid @enderror" id="seats_per_table" name="seats_per_table" value="{{ old('seats_per_table', $restaurant->seats_per_table) }}" min="1" max="20" required>
